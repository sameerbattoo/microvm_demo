                    ...
                    <div key={id} className={`vm-item ${isActive ? 'vm-item-active' : ''}`}>
                      <div className="vm-item-row" onClick={() => setExpandedVmId(isExpanded ? null : id)}>
                        ...
                        <div className="vm-item-info">
                          <span className="vm-item-name">{inst.name || attachedTab?.name || id.slice(-12)}</span>
                        ...
                        <div className="vm-detail">
                          ...
                          <div className="vm-detail-section">
                            ...
                            <div className="vm-detail-row">
                              <span className="vm-detail-label">ID</span>
                              <code className="vm-detail-value">{id}</code>
                            </div>
                            <div className="vm-detail-row">
                            ...
                            {!attachedIds.includes(id) && (
                              <div className="vm-detail-row">
                                ...
                                <span className="vm-detail-value vm-detail-unattached">Unattached</span>
                              </div>
                            )}
                          </div>
                          ...
                          <div className="vm-detail-actions">
                            ...
                            {state === 'SUSPENDED' && (
                              <button className="vm-action-btn vm-btn-attach" onClick={() => handleVmResume(id)} disabled={isActioning}>{isActioning ? '...' : 'Resume'}</button>
                            )}
                          </div>
                        </div>
                      )}
